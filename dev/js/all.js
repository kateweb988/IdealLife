...
document.addEventListener("DOMContentLoaded", () => {
  function controlFromInput(fromSlider, fromInput, toInput, controlSlider) {
    ...
    fillSlider(fromInput, toInput, '#C6C6C6', '#f1b306', controlSlider);
    if (from > to) {
      fromSlider.value = to;
      fromInput.value = to;
    } else {
  ...
  function controlFromSlider(fromSlider, toSlider, fromInput) {
    ...
    fillSlider(fromSlider, toSlider, '#C6C6C6', '#f1b306', toSlider);
    if (from > to) {
      fromSlider.value = to;
      fromInput.value = to;
    } else {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let openPopupButtons2 = document.querySelectorAll('.w1');
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let openPopupButtons3 = document.querySelectorAll('.w2');
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let openPopupButtons4 = document.querySelectorAll('.w3');
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let openPopupButtons5 = document.querySelectorAll('.w4');
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let openPopupButtons6 = document.querySelectorAll('.w5');
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let openPopupButtons7 = document.querySelectorAll('.w6');
